...
const PrintQuote = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div 
        ref={printRef} 
        className="bg-white p-8 rounded-md border shadow print:shadow-none print:w-[210mm] print:max-h-[148mm] print:overflow-hidden print:p-4 print:border-0 print:rounded-none quote-half"
      >
          ...
          <div className="grid grid-cols-2 gap-4 print:gap-2">
            <div>
              <p className="text-gray-600 flex items-baseline print:text-xs">
                ...
                <span className="border-b border-gray-300 flex-1 ml-2">{quote.customerName}</span>
              </p>
              <p className="text-gray-600 flex items-baseline mt-2 print:mt-1 print:text-xs">
                ...
                <span className="border-b border-gray-300 flex-1 ml-2">{quote.customerAddress || ""}</span>
              </p>
              <p className="text-gray-600 flex items-baseline mt-2 print:mt-1 print:text-xs">
              ...
              <p className="text-gray-600 flex items-baseline mt-2 print:mt-1 print:text-xs">
                ...
                <span className="border-b border-gray-300 flex-1 ml-2">{quote.customerPhone || ""}</span>
              </p>
            </div>
            <div>
              <p className="text-gray-600 flex items-baseline print:text-xs">
                <span className="font-medium text-gray-700 min-w-[100px] print:min-w-[80px]">Email: </span>
                <span className="border-b border-gray-300 flex-1 ml-2">{quote.customerEmail || ""}</span>
              </p>
              <p className="text-gray-600 flex items-baseline mt-2 print:mt-1 print:text-xs">
        ...
        {/* Customer Receipt Confirmation - simplified for half-page layout */}
        <div className="border border-gray-300 p-4 print:p-2 rounded mb-4 print:mb-2">
        ...
        {/* Footer - simplified for half-page layout */}
        <div className="text-center text-sm print:text-xs text-gray-500 print:pt-1 border-t border-gray-200">
          <p className="text-blue-700 print:text-blue-800">{quote.companyInfo?.name || "COMÉRCIO DE REFRIGERAÇÃO MIRANDA LTDA"}</p>
          <p className="text-blue-700 print:text-blue-800">{quote.companyInfo?.address || "Av. Principal, 1000 - Centro"}</p>
        </div>
      </div>
    </div>
  );
